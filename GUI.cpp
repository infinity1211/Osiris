...
void GUI::renderMiscWindow(bool contentOnly) noexcept
{
    ...
    ImGui::SameLine();
    hotkey(config->misc.bunnyHopKey);
    ...
    ImGui::SliderFloat("Max angle delta", &config->misc.maxAngleDelta, 0.0f, 30.0f, "%.2f");
        ...
        if (ImGui::BeginPopup("Config to reset")) {
            ...
            for (int i = 0; i < IM_ARRAYSIZE(names); i++) {
                ...
                if (ImGui::Selectable(names[i])) {
                    ...
                    case 4: config->glow = { }; break;
                    case 5: config->chams = { }; break;
                    case 6: config->streamProofESP = { }; break;
                    case 7: config->visuals = { }; break;
                    case 8: config->skinChanger = { }; SkinChanger::scheduleHudUpdate(); break;
                    case 9: config->sound = { }; break;
